...
public class SdkConfig {
    ...
    @Bean("borrowClient")
    public Client borrowClient(@Autowired RestTemplate restTemplate) {
    ...
    @Bean("smsClient")
    public Client smsClient(@Autowired RestTemplate restTemplate) {
        ClientConfig clientConfig = new ClientConfig();
        clientConfig.setHost(env.getProperty("remote.module.notity"));
        Client client = new Client(clientConfig);
        client.setConnectFactory(sdkConnectFactory());
        return client;
    }
    ...
    @Bean("userClient")
    public Client userClient(@Autowired RestTemplate restTemplate) {
        ClientConfig clientConfig = new ClientConfig();
