...
import com.hwc.framework.modules.third.business.zhengxin.entity.CreditRecordSummaryEntity;
 ...
 */
@Repository
public class CreditRecordSummaryRepository extends BaseDAO<CreditRecordSummaryEntity> {
...
//	}
    ...
    public void saveCreditRecordSummaryEntity(CreditRecordSummaryEntity entity)throws Exception  {
   ...
   public void deleteCreditRecordSummaryEntity(String userId,String mappingId,String reportNo){
	   String tableName = "t_creditrecordsummary";
