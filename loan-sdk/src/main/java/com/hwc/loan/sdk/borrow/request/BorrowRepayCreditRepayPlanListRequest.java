...
import com.hwc.loan.sdk.borrow.response.BorrowRepayCreditRepayPlanListResponse;

public class BorrowRepayCreditRepayPlanListRequest extends RequestBase<BorrowRepayCreditRepayPlanListResponse> {

    public static final String METHOD = "/api/borrow/repay/credit/repayPlanList";
    ...
    public BorrowRepayCreditRepayPlanListRequest() {
        super(METHOD);
    }
