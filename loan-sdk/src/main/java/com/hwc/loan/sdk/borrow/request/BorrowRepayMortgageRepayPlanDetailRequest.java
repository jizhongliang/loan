...
import com.hwc.loan.sdk.borrow.response.BorrowRepayMortgageRepayPlanDetailResponse;

public class BorrowRepayMortgageRepayPlanDetailRequest extends RequestBase<BorrowRepayMortgageRepayPlanDetailResponse> {

    public static final String METHOD = "/api/borrow/repay/mortgage/repayPlanDetail";
    ...
    public BorrowRepayMortgageRepayPlanDetailRequest() {
        super(METHOD);
    }
