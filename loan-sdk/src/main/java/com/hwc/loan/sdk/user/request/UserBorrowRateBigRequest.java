 ...
 */
public class UserBorrowRateBigRequest extends RequestBase<ResponseBase> {
    public static final String METHOD = "/api/user/getBorrowRateBig";

    public UserBorrowRateBigRequest() {
        super(METHOD);
    }
