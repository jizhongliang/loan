...
public class ManageMortgageUpdateByPhoneRequest extends RequestBase<ManageMortgageUpdateByPhoneResponse> {

    public static final String METHOD = "/manage/mortgage/updateMortgageByPhone";


    public ManageMortgageUpdateByPhoneRequest() {
        super(METHOD);
    }
