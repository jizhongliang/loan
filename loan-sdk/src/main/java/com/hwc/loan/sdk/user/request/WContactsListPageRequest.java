...
public class WContactsListPageRequest extends ItemsRequest<WContactsListPageResponse> {

    public static final String METHOD = "/mana/user/wContacts/listPage";

    public WContactsListPageRequest() {
        super(METHOD);
    }
