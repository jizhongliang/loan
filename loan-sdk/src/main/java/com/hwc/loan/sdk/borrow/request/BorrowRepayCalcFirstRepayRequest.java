...
import com.hwc.loan.sdk.borrow.response.BorrowRepayCalcFirstRepayResponse;

public class BorrowRepayCalcFirstRepayRequest extends RequestBase<BorrowRepayCalcFirstRepayResponse> {

    public static final String METHOD = "/api/borrow/repay/calcFirstRepay";
    ...
    public BorrowRepayCalcFirstRepayRequest() {
        super(METHOD);
    }
