...
import com.hwc.loan.sdk.admin.response.MenuUpdateOneResponse;

public class MenuUpdateOneRequest extends RequestBase<MenuUpdateOneResponse> {

    public static final String METHOD = "/api/admin/sys/menu/updateOne";

    public MenuUpdateOneRequest() {
        super(METHOD);
    }
