 ...
 */
public class SysUserUpdateOneRequest extends RequestBase<SysUserUpdateOneResponse> {
    public static final String METHOD = "/api/admin/sys/user/updateOne";

    public SysUserUpdateOneRequest() {
        super(METHOD);
    }
