...
import com.hwc.loan.sdk.borrow.response.MortgageApplyResponse;

public class MortgageApplyRequest extends RequestBase<MortgageApplyResponse> {

    public static final String METHOD = "/api/mortgage/apply";
