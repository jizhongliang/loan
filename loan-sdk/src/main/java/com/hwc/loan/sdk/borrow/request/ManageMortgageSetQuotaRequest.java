...
import com.hwc.loan.sdk.borrow.response.ManageMortgageSetQuotaResponse;

public class ManageMortgageSetQuotaRequest extends RequestBase<ManageMortgageSetQuotaResponse> {

    public static final String METHOD = "/manage/mortgage/setQuota";
    ...
    public ManageMortgageSetQuotaRequest() {
        super(METHOD);
    }
