...
import com.hwc.loan.sdk.borrow.response.CreditBorrowApplyResponse;

public class CreditBorrowApplyRequest extends RequestBase<CreditBorrowApplyResponse> {

    public static final String METHOD = "/api/credit/borrow/apply";
    ...
    public CreditBorrowApplyRequest() {
        super(METHOD);
    }
