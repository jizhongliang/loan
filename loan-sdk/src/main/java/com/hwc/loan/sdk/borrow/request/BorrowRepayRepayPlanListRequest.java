...
public class BorrowRepayRepayPlanListRequest extends RequestBase<BorrowRepayRepayPlanListResponse> {

    public static final String METHOD = "/api/borrow/repay/repayPlanList";
    ...
    public BorrowRepayRepayPlanListRequest() {
        super(METHOD);
    }
