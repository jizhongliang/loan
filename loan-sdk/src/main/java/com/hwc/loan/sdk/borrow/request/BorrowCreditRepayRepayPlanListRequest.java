...
public class BorrowCreditRepayRepayPlanListRequest extends RequestBase<BorrowCreditRepayRepayPlanListResponse> {
    ...
    public BorrowCreditRepayRepayPlanListRequest() {
        super(METHOD);
    }
