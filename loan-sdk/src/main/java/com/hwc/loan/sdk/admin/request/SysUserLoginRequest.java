...
public class SysUserLoginRequest extends RequestBase<SysUserLoginResponse> {

    public static final String METHOD = "/api/admin/sys/user/login";

    public SysUserLoginRequest() {
        super(METHOD);
    }
