...
import com.hwc.loan.sdk.borrow.response.MortgageBorrowWithdrawResponse;

public class MortgageBorrowWithdrawRequest extends RequestBase<MortgageBorrowWithdrawResponse> {

    public static final String METHOD = "/api/mortgage/borrow/withdraw";
    ...
    public MortgageBorrowWithdrawRequest() {
        super(METHOD);
    }
